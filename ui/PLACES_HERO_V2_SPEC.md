...
Currency card:
- Currency is presented inside a small bordered card in the bottom-left quadrant.
- The card is visually stable and does not reflow other hero content.
